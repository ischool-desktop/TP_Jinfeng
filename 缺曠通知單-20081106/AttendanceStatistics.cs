...
namespace 缺曠通知單
{
    public class AttendanceStatistics
    {
        ...
        private void InternalStatistics(List<AttendanceInfo> AttendanceList, string StartDate, string EndDate, List<string> MeetingList, List<string> GeneralList)
        {
        ...
        {
            InternalStatistics(AttendanceList,StartDate,EndDate,MeetingList,GeneralList);
        }
