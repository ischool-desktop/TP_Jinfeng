...
namespace 缺曠通知單
{
    public class ActivityNotificationTemplate : ISchoolDocument
    {
        ...
        public ActivityNotificationTemplate(System.IO.Stream Stream, List<string> MeetingList, List<string> GeneralList)
        {
            mMeetingList = MeetingList;
            mGeneralList = GeneralList;
        ...
        public int ProcessDocument()
        {
            ...
            DocumentBuilder builder = new DocumentBuilder(mtemplate);
            ...
            Table table = mtemplate.Sections[0].Body.Tables[0];
            ...
            {
                Cell newCell = new Cell(mtemplate);
                ...
                newCell.Paragraphs.Add(new Paragraph(mtemplate));
                ...
                newCell.Paragraphs[0].Runs.Add(new Run(mtemplate, attendanceType));
